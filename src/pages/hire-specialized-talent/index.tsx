                        ...
                        <div className="row">
                            <div className="col-md-7">
                                <div className="homesapExpertise" >
                                    ...
                                    <div className="hireSap"><a className="hire" href="/search-developers">Search Specialized Talent</a>
                                        {/* <a className="hire" href"#">Explore Talent Pool</a> */}
                                    </div>
                        ...
                        <div className="row ">
                            ...
                            <div style={{ display: "flex", justifyContent: "center" }}>
                                <div className="hireSap"><a className="hire" href="/sap-talent-pool">Explore Talent Pool</a><a className="hire"
                                    href="/search-developers">Hire Elite Talent</a></div>
                            </div>
                        </div>
                    </section>
                </div>
