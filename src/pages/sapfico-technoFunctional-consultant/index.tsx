                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 ">
                                <div className="superchargeCont">
                                    ...
                                    <div className="superchargeText">Design, configure, and implement SAP Finance (FI) and Controlling (CO) modules with a blend of functional and technical skills.</div>
                            ...
                            <div className="col-md-4 ">
                                <div className="superchargeCont">
                                    ...
                                    <div className="superchargeText">Translate business needs into effective SAP configurations and technical functionalities.</div>
