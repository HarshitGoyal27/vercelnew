                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 ">
                                <div className="superchargeCont">
                                    ...
                                    <div className="superchargeHeading"><h3>Primary Responsibilities</h3></div>
                                    <div className="superchargeText">Configuring and implementing SAP Finance (FI) and Controlling (CO) modules.</div>
                            ...
                            <div className="col-md-4 ">
                                <div className="superchargeCont">
                                    ...
                                    <div className="superchargeText">Work closely with business stakeholders to understand requirements.</div>
                            ...
                            <div className="col-md-4 ">
                                <div className="superchargeCont">
                                    ...
                                    <div className="superchargeText">Translate business needs into effective SAP solutions.</div>
                    ...
                    <section className="container mt-4 ">
                        <div className="row">
                            ...
                            <div className="col-md-4 Initiatives">
                                ...
                                <p> Tailor SAP FICO modules to meet business requirements.</p>
                            </div>
                            <div className="col-md-4 Initiatives">
                                <img src="images/icon27.png" alt="On-Demand Expertise" className="img-fluid" /><br />
                                <h5>System Testing</h5>
                                <p>Conduct and support system and user acceptance testing (UAT).</p>
                            </div>
                            ...
                            <div className="col-md-4 Initiatives">
                                ...
                                <h5>User Training</h5>
                                <p>Provide post-implementation support and train end-users.</p>
                            </div>
